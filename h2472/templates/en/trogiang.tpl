		...
		<div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				...
				<div class="module clearfix">
					...
					<h3><span style="float:left;color:#ffffff; margin-top:8px;">Teaching Assistant<strong class="member" style="color:#ffffff">{user}</strong></span><span style="float:right;color:#ffffff;margin-top:8px;"><a style="color:#ffffff" target="_blank" href="{linkportal}" title="">Amatop Home page</a> &nbsp;|&nbsp; <a style="color:#ffffff" target="_blank" href="{linkforum}" title="">Forum</a> 
