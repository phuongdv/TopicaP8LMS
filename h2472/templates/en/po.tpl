		...
		<div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				...
				<div class="module clearfix">
					...
					<h3><span style="float:left;color:#ffffff; margin-top:8px;">PO <strong class="member" style="color:#ffffff">{user}</strong></span><span style="float:right;color:#ffffff;margin-top:8px;"><a style="color:#ffffff" target="_blank" href="{linkportal}" title="">Amatop Home page</a> &nbsp;|&nbsp; <a style="color:#ffffff" target="_blank" href="{linkforum}" title="">Forum</a> 
                  ...
                  <table width="692" cellpadding="1" cellspacing="10">
							...
							<tr>
							  ...
							  <td align="right" style="padding-right:0px;" ><button type="button" style="width:120px;"  onclick="return creatanswer();">Make new question </button>&nbsp <input type="button" onclick="window.open('?act=export&sql={sql}','_self');" value="Export to Excel"></td>
