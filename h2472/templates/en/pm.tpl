		...
		<div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				<div class="module clearfix">
					<h3>
						<span style="float:left;color:#ffffff;margin-top:8px;">
							PM: 
						...
						<span style="float:right;color:#ffffff;margin-top:8px;">
							...
							<a style="color:#ffffff" href="{linkdiendan}" title="" >
								Forum 
							</a>&nbsp; | &nbsp; 
...
<div class="modulecontent clearfix">
						...
						<table cellpadding="1" cellspacing="10">
							...
							<tr>
							  ...
							  <td>
							    ...
							    <select name="do" id="do" class="dropdown" style="width:150px">
							      <option value="0" {selected_1}> Dispaly all questions </option>
							...
							<tr>
                              ...
                              <td style="padding-right:50px;"><button type="button"  style="width:120px" onclick="return creatanswer();">Make new question </button></td>
						  </tr>
			</table> 
<div style="float:right;margin-top:-160px" >
                        <table class="list" width="200" border="0" cellpadding="1" cellspacing="1">
                          ...
                          <tr>
                            ...
                            <td colspan="2" width="110">Unaswered</td>
