...
<h3><span style="float:left;color:#ffffff;margin-top:8px;">Remote system administration <strong class="member" style="color:#ffffff">{user}</strong></span><span style="float:right;color:#ffffff;margin-top:8px;"><a style="color:#ffffff" href="{linkforum}" title="" >Forum </a>&nbsp; | &nbsp; <a style="color:#ffffff" href="./?act=logout" title="" >Return to classroom</a></span></h3>
...
<div style="float:right;margin-top:-160px" >
                        <table class="list" width="200" border="0" cellpadding="1" cellspacing="1">
                          ...
                          <tr>
                            ...
                            <td><a href=" " title="ау tr? l?i">{datraloi}</a> &nbsp;<img height="10px" src="1do.png" />&nbsp;<img height="10px" width="2px" src="1luc.png" /> </td>
                            <td>{qs_repl}</td>
                          </tr>
                          <tr>
