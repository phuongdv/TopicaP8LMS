        ...
        <div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				...
				<div class="module clearfix">
					...
					<h3><span  style="color:#ffffff; float:left; margin-top:8px;"><strong class="member" style="color:#ffffff">{user}</strong><label style="padding-left:20px;color:#ffffff"> Topic ID:&nbsp;{id_answer}&nbsp; </label>

					<label style="color:#ffffff">&nbsp;{assigner}&nbsp;|&nbsp;Status : {thread_status} </label></span><span style="float:right;color:#ffffff;margin-top:8px;"><a href="./?do=view_kkt" title="" style="color:#ffffff">Knowledge base </a>&nbsp; | &nbsp; <a style="color:#ffffff" href="{linkforum}" title="" >Forum </a>&nbsp; | &nbsp; <a  style="color:#ffffff" href="./?act=logout" title="" >Return to classroom</a>&nbsp; | &nbsp; <a style="color:#ffffff" href="/h2472" title="" >Back to home page H2472</a></span></h3>
				    ...
				    <!-- BEGIN A_DETAIL -->
						...
						<div class="adetail">
							...
							<div class="detail-left">
							    ...
							    <a href="{linkelearning}/user/view.php?id={A_DETAIL.uid}" target="_blank"><strong>{A_DETAIL.author}</strong></a></p>
...
<div class="detail-right">
								...
								<div class="detail-status">
									...
									Question type : {A_DETAIL.topic}-- Subject : <strong>                                    {A_DETAIL.cname}</strong><br />&nbsp; &nbsp; {A_DETAIL.link}{A_DETAIL.thread_edit}</div>

			    <div class="detail-title"><img src="./images/q.png" width="32" height="32" /> Question No. :{A_DETAIL.id} - {A_DETAIL.title}{A_DETAIL.edit}</div>
						...
						<div class="lreplay"  style="{A_DETAIL.lreplay}" >
							...
							<div class="repley-left">
								...
								<a href="{linkelearning}/user/view.php?id={A_DETAIL.repuid}" target="_blank"><strong>{A_DETAIL.reply_author}</strong></a>
...
<div id="replyform" class="areply2" style=" display:none;">
							...
							<table cellpadding="1" cellspacing="10">
								...
								<tr>
									...
									<td colspan="2"><span class="replyform">Answer this question</span></td>
			...
			//]]>
								...
								<tr>
									...
									<td colspan="2"><input type="submit" name="addreply" value="Accept" onclick="ste.submit();" />                </td>
...
<div id="questionform" class="areply2" style=" display:none;">
							...
							<table cellpadding="1" cellspacing="10">
								...
								<tr>
									...
									<td colspan="2"><span class="replyform">Add question</span></td>
			...
			//]]>
								...
								<tr>
									...
									<td colspan="2"><input type="submit" name="addquestion" value="Accept" onclick="ste.submit();" /></td>
