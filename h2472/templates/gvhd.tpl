...
<div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				...
				<div class="module clearfix">
					...
					<h3><span style="float:left;color:#ffffff;margin-top:8px;">Giảng viên <strong style="color:#ffffff" class="member">{user}</strong></span><span style="float:right;color:#ffffff;margin-top:8px;"> <a style="color:#ffffff" href="./?do=view_kkt" title="" >Kho kiến thức </a>&nbsp; | &nbsp;<a style="color:#ffffff" href="{linkportal}" title="" >Trang chủ topica </a> &nbsp; | &nbsp; <a style="color:#ffffff" href="{linkforum}" title="" >Diễn đàn </a>&nbsp; | &nbsp; <a style="color:#ffffff" href="./?act=logout" title="" >Quay về lớp học</a></span></h3>
							...
							<tr>
							  ...
							  <td>
							      ...
							      <select name="lstStatus" id="lstStatus" class="dropdown" style="width:150px">
                                    ...
                                    <option value="6" {STATUS.select6}>Đã trả lời hoặc đã đóng</option>                                   <!-- END STATUS -->
