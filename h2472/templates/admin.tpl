...
<!-- BEGIN SUBJECT -->
						  ...
						  <td><select name="delay" id="delay" class="dropdown" style="width:150px" >
							...
							<tr>
                              ...
                              <td style="padding-right:50px;"><button type="button"  style="width:120px" onclick="return creatanswer();">Đặt câu hỏi mới </button> &nbsp <input type="button" onclick="window.open('?act=export&sql={sql}','_self');" value=" Xuất excell "></td>
						  </tr>
			</table> 
