		...
		<div id="content_knowledge">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				<div class="module clearfix">
					<h3><span style="float:left;color:#ffffff; margin-top:8px;"><strong class="member" style="color:#FFF">{user}</strong></span><span style="float:right;color:#ffffff; margin-top:8px;" > <a href="./?act=logout" title="" style="color:#FFF" >Quay về lớp học</a> |  <a href="javascript: window.close()" title="" style="color:#FFF">Đóng của sổ</a></span></h3>
					<div class="modulecontent clearfix">
						...
						<table width="391" cellpadding="1" cellspacing="10">
							...
							<tr>
							  <td>
							  <td><input type="button" name="btnTim" id="btnTim" value="      Tìm kiếm     " style="" onclick="window.open('?do=knowledge&subject='+document.getElementById('course').value+'&searchtext='+document.getElementById('txtFulltext').value,'_self'); " />
						      <input type="button" name="btnClear" id="btnClear" style="" value="     Xem tất cả     " onclick="window.open('?do=knowledge','_self'); " /></td>
						  </tr>
						</table>
