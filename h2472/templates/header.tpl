...
<title>Topica  - Giai dap Thac mac cho Sinh vien 24x72 </title>
...
<script type="text/javascript">
  ...
  _paq.push(["setCookieDomain", "*.elearning.tvu.topica.vn"]);
  _paq.push(["trackPageView"]);
  _paq.push(["enableLinkTracking"]);

  (function() {
    var u=(("https:" == document.location.protocol) ? "https" : "http") + "://210.245.88.169/topica/";
...
<link rel="stylesheet" type="text/css" href="includes/stars.css" />
...
<div id="wrapper">
	...
	<div id="header">
		...
		<iframe scrolling="no" height="90px" frameborder="0" width="1000px" border="0" framespacing="0" src="http://dev.lms.amatop.ph/theme/topica/head.html"></iframe>
