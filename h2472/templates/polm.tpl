		...
		<div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				...
				<div class="module clearfix">
					...
					<h3><span style="float:left;color:#ffffff; margin-top:8px;">PO Lớp môn <strong class="member" style="color:#ffffff">{user}</strong></span><span style="float:right;color:#ffffff;margin-top:8px;"><a style="color:#ffffff" target="_blank" href="{linkportal}" title="">Trang chủ TOPICA</a> &nbsp;|&nbsp; <a style="color:#ffffff" target="_blank" href="{linkforum}" title="">Diễn đàn</a> 
                  ...
                  <table width="692" cellpadding="1" cellspacing="10">
                      ...
                      <div style="float:right;margin-top:-180px" >
                      	...
                      	<div style="float:left; width:120px;"><a class="modal" rel="{handler: 'iframe', size: {x: 750, y: 500}}"  href="ds_cvht.html">Danh sách CVHT</a></div>

							  <div ><a class="modal" rel="{handler: 'iframe', size: {x: 750, y: 500}}"  href="ds_po.html">Danh sách PO</a></div>
