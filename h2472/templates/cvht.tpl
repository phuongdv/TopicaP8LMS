		...
		<div id="content">
			...
			<div class="frame-mid"><div class="frame-ml"><div class="frame-mr">
				...
				<div class="module clearfix">
					...
					<h3><span style="float:left;color:#ffffff;margin-top:8px;">Cán bộ quản lý học tập <strong style="color:#ffffff" class="member">{user}</strong></span><span style="float:right;color:#ffffff;margin-top:8px;"><a style="color:#ffffff" href="./?do=view_kkt" title="" >Kho kiến thức </a>&nbsp; | &nbsp;<a style="color:#ffffff" href="{linkportal}" title="" >Trang chủ topica </a> &nbsp; | &nbsp; <a style="color:#ffffff" href="{linkforum}?u={username}" title="" >Diễn đàn </a>&nbsp; | &nbsp; <a style="color:#ffffff" href="./?act=logout" title="" >Quay về lớp học</a></span></h3>
							...
							<tr>
							  ...
							  <td>
							      ...
							      <select style="width:150px" name="lstStatus" id="lstStatus" class="dropdown">
							        ...
							        <option value="2">Chờ trả lời</option>
