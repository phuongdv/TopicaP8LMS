...
$config['Database']['dbname'] = 'amatoplms';
...
$config['MasterServer']['username'] = 'amatoplms';
$config['MasterServer']['password'] = 'KrWuTbNY';
...
$config['SlaveServer']['username'] = 'amatoplms';
$config['SlaveServer']['password'] = 'KrWuTbNY';
