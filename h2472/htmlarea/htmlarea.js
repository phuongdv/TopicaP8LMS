...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "popupeditor", "separator", "showhelp", "separator", "undo", "redo" ]
	];
...
HTMLArea.checkSupportedBrowser = function() {
	if (HTMLArea.is_gecko) {
		...
		if (navigator.productSub < 20030210) {
			alert("He thong h2472 hoat dong tot nhat tren trinh duyet Firefox\n" +
			      "Co the co loi xay ra neu ban su dung trinh duyet Chrome hoac Safari.");
		}
	}
