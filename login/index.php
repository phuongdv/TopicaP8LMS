...
/// Check if the user has actually submitted login data to us
   ...
   {
    // set cookie
	        setcookie("f","",time()-3600*24,"/","topica.edu.vn");
			setcookie("user","",time()-3600*24,"/","topica.edu.vn");
	...
	$url=curPageURL();
			setcookie("user",$url,time()+3600*24,"/","amatop.ph");
            require '../vietth/securecookie.php';
            $C = new SecureCookie('6rCgffX5mX','Iq6cJ0116W',time()+3600*24,'/','amatop.ph');
       ...
       // end set cookie
           ...
           // set cookies for new version
           $C2 = new SecureCookie('beGBDSYq','SID',false,'/','.amatop.ph');
		   $C2->Set('uid',$USER->id);
		   $C2->Set('username',$USER->username);
           $C2->Set('name',$USER->firstname.' '.$USER->lastname);
           $C2->Set('role',check_role($USER->username));
