...
<div id="sortable">
	...
	<div class="one_full">
		...
		<section class="draggable title">
			<h4>Quick Links</h4>
			<a class="tooltip-s toggle" original-title="Toggle this element"></a>
		</section>

		<section class="item 1" id="quick_links">
			<div class="content">
				<ul>

					<li>
						<a href="/admin/menu" class="tooltip-s" original-title="Manage Menu"><img src="/system/cms/themes/pyrocms/img/icons/pages.png" alt="Manage Menu"></a>
					</li>

					<li>
						<a href="/admin/category" class="tooltip-s" original-title="Manage Section"><img src="/system/cms/themes/pyrocms/img/icons/files.png" alt="Manage Section"></a>
					</li>

					<li>
						<a href="/admin/users" class="tooltip-s" original-title="Manage Users"><img src="/system/cms/themes/pyrocms/img/icons/users.png" alt="Manage Users"></a>
					</li>
				</ul>
			</div>
		</section>
