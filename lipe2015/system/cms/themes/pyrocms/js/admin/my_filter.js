	...
	pyro.filter = {
		...
		init: function(){
			...
			$('a.cancel', pyro.filter.$filter_form).click(function() {
					...
					$('select[name="category_id"]', pyro.filter.$filter_form).val('0');
					$('select[name="parent_id"]', pyro.filter.$filter_form).val('0');
                    $('select[name="f_parent_id"]', pyro.filter.$filter_form).val('-1');
					$('select[name="f_art_parent_id"]', pyro.filter.$filter_form).val('-1');
					$('select[name="active"]', pyro.filter.$filter_form).val('2');
					$('select[name="f_active"]', pyro.filter.$filter_form).val('2');
					$('select[name="status"]', pyro.filter.$filter_form).val('2');
					$('select[name="f_status"]', pyro.filter.$filter_form).val('2');
					$('select[name="f_on_home_page"]', pyro.filter.$filter_form).val('2');
					$('select[name="f_interest"]', pyro.filter.$filter_form).val('2');
					$('select[name="f_vip"]', pyro.filter.$filter_form).val('2');
					$('select[name="f_type"]', pyro.filter.$filter_form).val('2');
                    $('select[name="f_group"]', pyro.filter.$filter_form).val('0');
