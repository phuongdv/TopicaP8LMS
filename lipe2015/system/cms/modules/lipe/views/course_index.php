...
<div class="search_box">
	<div class="content_box">
		<?php echo form_input('shortname',$base_where['shortname'],'class="text_field_search" placeholder="Nhập tên lớp môn hoặc tên lớp học"');?>
		<?php echo form_dropdown('mode',$modes,$base_where['mode'],'class="search"');?>
		<?php echo form_submit('search','Tìm kiếm');?>
	</div>
</div>
<div class="table_content">
	<div class="content_box"><div class="total_rows">Tổng số bản ghi là: <span><?php echo number_format($total_rows);?></span></div></div>
	<div id="filter_stage">
