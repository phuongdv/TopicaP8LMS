...
<div class="search_box">
	<div class="content_box">
		...
		<?php echo form_input('number',$base_where['number'],'class="text_field_search_small" placeholder="Số buổi offline"');?>
		<?php echo form_input('btvn',$base_where['btvn'],'class="text_field_search_small" placeholder="Điểm"');?>
		...
		<?php echo form_submit('search','Tìm kiếm');?>
...
<div class="table_content">
	<div class="content_box">
		<div class="total_rows">
			...
			<div class="right"><?php echo form_submit('update','Cập nhật tất cả');?></div>
		</div>
	</div>
	<div id="filter_stage">
