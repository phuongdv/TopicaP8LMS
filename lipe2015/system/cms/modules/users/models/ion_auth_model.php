...
class Ion_auth_model extends CI_Model
{
	...
	public function update_user($id, $data, $profile_data)
	{
		...
		//CaoPV:Modified on 15-03-2014
		if(!empty($profile_parsed_data)){
			foreach($profile_parsed_data as $key=>$value){
				if(!$profile_parsed_data[$key])
					unset($profile_parsed_data[$key]);
			}
		}
