...
<ul>
	...
	<li class="form_buttons">
		<div style="padding-left: 100px;"><input type="submit" value="<?php echo lang('user:login_btn') ?>" name="btnLogin" /> <span class="register"> | <?php echo anchor('register', lang('user:register_btn'));?> | <?php echo anchor('users/reset_pass', lang('user:reset_password_link'));?></span></div>
	</li>
</ul>
<?php echo form_close() ?>