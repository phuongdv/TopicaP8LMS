...
class xpMenu{
	...
	*/
	...
	function style(){
		...
		.Option
		{width: '.$this->option_width.'; height: '.$this->option_height.'; padding:2 5 3 2; border: 1 1 1 1 solid '.$this->option_bordercolor.'; background-color: '.$this->option_backgroundcolor.'; cursor:'.$this->option_cursor.';}
