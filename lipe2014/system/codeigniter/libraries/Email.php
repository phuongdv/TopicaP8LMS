...
class CI_Email {
	...
	public $smtp_crypto	= 'ssl';			// SMTP Encryption. Can be null, tls or ssl.
	...
	protected $_protocols		= array('mail', 'sendmail', 'smtp','smtp2');
	 ...
	 * @author CaoPV
	 */
	protected function _send_with_smtp2()
	{
		...
		$mail->IsSMTP();
		$mail->SMTPAuth = true;
		$mail->SMTPSecure = $this->smtp_crypto;
		$mail->Host = $this->smtp_host;
		$mail->Port = $this->smtp_port;
		$mail->Username = $this->smtp_user;
		$mail->Password = $this->smtp_pass;

		$mail->Subject = $this->_headers['Subject'];
		$mail->AltBody = "This is the body when user views in plain text format"; //Text Body

		$mail->WordWrap = $this->wrapchars; // set word wrap

		$mail->MsgHTML($this->_body);

		$mail->SetFrom(Settings::get('server_email'),'Ban quản trị '.Settings::get('site_name'));

		//$mail->AddReplyTo(Settings::get('contact_email'),'Văn Cao');

		$mail->AddAddress($this->_headers['To'],'You');
