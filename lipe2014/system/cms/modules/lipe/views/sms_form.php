...
<div class="content_header">
	<?php echo anchor('/lipe','<img src="'.IMAGE_PATH.'user.gif"></a><span class="title">Send an SMS message: '.$course->shortname.'</span>','class="logo_icon"');?>
</div>
...
<div class="content_box pdtop">
	<div class="left_sms">
		...
		<?php echo form_submit('search','Filter data');?>
		...
		<table class="table_list sms_table" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td colspan="8" class="red"><b>Add your phone number to check(<?php echo $user_data['user_phone'];?>)</b></td>
			</tr>
		</table>
	</div>
	<div class="right_sms">
		<table class="table_form_mini">
			<tr>
				<td>
					<b class="mau_dac_trung">Message content:</b>
					...
					<br/><span id="number_character">0</span> characters
				</td>
			</tr>
			<tr>
				<td>
					<?php echo form_submit('send','Send SMS','onclick="checkForm()"');?>
					<?php echo form_reset('reset','Reset');?>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<span class="comment">( * Note: Message content must not exceed 160 characters )</span>
				</td>
			</tr>
		</table>
	</div>
