...
/* End of file constants.php */
define('IMAGE_PATH','./system/cms/themes/mytheme/images/');
define('IMAGE_ADMIN_PATH','./system/cms/themes/pyrocms/images/');
define('IMAGE_PATH_SLIDE','./uploads/slide/');
define('DATETIME_DISPLAY_FORMAT', "d-m-Y H:i:s");
define('DATETIME_FORMAT', "Y-m-d H:i:s");
define('DATE_FORMAT',"d-m-Y");
define('DATE_DATABASE_FORMAT',"Y-m-d");
define('LIMIT_SEND_MAIL',2);
define('LIMIT_NEWS_PER_DAY',5);
define('RECORDS_PER_PAGE',10);
define('RECORDS_PER_PAGE_CLIENT',10);
define('RECORDS_PER_PAGE_BLOCK',8);
define('LIMIT_PAGE_IN_BLOCK',5);

define('COMMON_TITLE','Lipe - Topica');
define('COMMON_KEYWORD','Lipe - Topica');
define('COMMON_DESCRIPTION','Lipe - Topica');
define('FILE_EXCEL_PATH','./uploads/excel/');
define('CACHE_PARAM','CAO');