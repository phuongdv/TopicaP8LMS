...
///////////////////////////////////////////////////////////////////////////
	...
	//tinhth - 2013-07-30: tab tren Blog diem
	$row[] = new tabobject('bt30',

                           $CFG->wwwroot.'/grade/report/bt30/index.php?id='.$courseid,

                           get_string('Xem diem BT30-BT72', 'BT30'));
	//end tinhth - 2013-07-30: tab tren Blog diem
    $tabs[] = $row;
