<?php //$Id: lib.php,v 1.120.2.22 2009/01/16 14:56:59 nicolasconnault Exp $
...
function course_have_bt72($course) {  
	global $CFG;  $mysqli = new mysqli($CFG->dbhost,$CFG->dbuser,$CFG->dbpass);		  
		$mysqli->select_db($CFG->dbname);	     
		$mysqli->query("SET NAMES 'utf8'");		  		 
		$sql  = "select * from vietth_q169_de where course_id=".$course ;	
		$rc = $mysqli->query($sql);			
