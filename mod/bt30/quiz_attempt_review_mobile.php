...
<div align="center"><a data-ajax="false" style="font-size:1.4em;font-weight:bold"  data-role="button" href="/mod/bt30/bt30_mobile.php?q='.$quiz_id.'" >Quay lại </a></div>';
  ...
  ?>
		...
		>  <hr>
			...
			<fieldset><legend>Chọn một câu trả lời</legend>
				...
				<li class="<?php echo $class;?>">
					<label>
					<input disabled  type="radio" name="choice_id_<?php echo $rows["id"];?>" value="<?php echo $rows_answer["id"];?>"
                    <?php 
					...
					else if($choices_array[$i]==$rows_answer["id"] and $rows_answer["fraction"]==1 )
						{
						$diemtong++;
			...
			?>
			<div class="reasons" id="reasons_<?php echo $rows["id"];?>"><strong>Điểm : <?php echo $diemcau;
			if(count($cham_lai[0])>0 )
		     {
	...
	echo '<div align="center"><a data-ajax="false" style="font-size:1.4em;font-weight:bold"  data-role="button" href="/mod/bt30/bt30_mobile.php?q='.$quiz_id.'" >Quay lại </a></div>';
