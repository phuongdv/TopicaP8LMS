...
?>
<form action="quiz_attempt_mobile.php" method="get">
...
if ($quiz_info['timeclose']!=0 && time()>$quiz_info['timeclose'])
 {
	 $exp=0;
	 echo '<h2 style="text-align:center">Bài đã đóng</h2>';
	 echo '<a  href="http://m.tvu.topica.vn/btvn.html" data-role="button" data-ajax="false">Quay lại</a>';
	 die();
...
if ($quiz_info['timeopen']!=0 && time()<$quiz_info['timeopen'])
 {
	 $exp=0;
	 echo '<h2 style="text-align:center">Bài chưa được mở</h2>';
	 echo '<a  href="http://m.tvu.topica.vn/btvn.html" data-role="button" data-ajax="false">Quay lại</a>';
	 die();
 }
...
{
	echo '<h2 style="text-align:center">Bạn đã hết lượt làm bài!</h2>';
	?>
	<a  href="<?php echo $_COOKIE['back_url'];?>" data-role="button" data-ajax="false">Quay lại</a>
<?php
	}
