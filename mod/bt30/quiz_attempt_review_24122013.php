...
<fieldset>
				...
				<?php if($rows_answer["fraction"]==1) // neu la dap an
					...
					if($choices_array[$i]!=0 and $choices_array[$i]==$rows_answer["id"] and $rows_answer["fraction"]==1 )
						{
						$diemtong++;
					...
					elseif($choices_array[$i]!=0 and $choices_array[$i]==$rows_answer["id"] and $rows_answer["fraction"]!=1)
					  {
