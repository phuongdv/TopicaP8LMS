...
for($i=1;$i<=$num;$i++){
	...
	$sql_insert.=" VALUES ('$qid','".$rows_course["id"]."','$code','$questids','$count_quest','$stranswer','$file_quiz','$timelimit','".$rows_quiz['timeopen']."','".$rows_quiz['timeclose']."','".$rows_quiz['name']."','$i','bt72')";
	@mysql_query($sql_insert);
	$lastid=mysql_insert_id();
	//echo $file_quiz;
	//echo "http://elearning.hou.topica.vn/vietth/bt30/create_quiz_html.php?qid=$qid&id=$lastid";
	//die();
	wwwcopy("http://elearning.tvu.topica.vn/mod/bt72/create_quiz_html.php?qid=$qid&id=$lastid",$file_quiz);
