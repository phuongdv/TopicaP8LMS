...
if(mysql_num_rows($result)>=3){
	echo "<h3 style='color:red; text-align:center;'>Bạn đã làm bài thi 3 lần. Bạn không có quyền tiếp tục làm bài. Liên hệ với ban quản trị để tiếp tục!</h3><a href='http://elearning.hou.topica.vn/course/view.php?id=$course_id' style='text-align:center;'>Quay lại lớp học</a>";
	die();
}
/*--- Check lan lam bai --*/
...
<body onLoad="genCode(<?php echo $id?>);"  >
	<div id="wapper" align="center">
    	<div id="title">
            ...
            <div style="width:960px" align="left"><span class="title_top"><a href="http://ccms.topica.vn/mycc.php"  target="_blank" >GÓP Ý</a></span></div>
        </div>
    	<div id="left">
                    ...
                    <tr>
                    	<td>
                        	<table cellpadding="0" cellspacing="0" border="0" width="100%">
                            	<tr>
                                	<td colspan="2"><span style="color:#FF0000"><b>Chú ý</b></span>: Trong trường hợp ngừng kết nối internet, đề nghị anh chị học viên vẫn tiếp tục làm bài và nộp bài bình thường. Khi ấn nộp bài xong, anh chị (ấn CtrlA) và (ấn CtrlC) copy hết đoạn mã kiểm tra bên dưới gửi mail cho CVHT lớp mình để xác nhận điểm bài làm</td>
                                </tr>
                                <tr>
