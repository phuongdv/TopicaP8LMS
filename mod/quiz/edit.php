...
/// all commands have been dealt with, now print the page
	...
	//BT30 - Chuc nang tao quiz - Tinhth
	if($quiz->grademethod ==2){
		echo '<a href="/mod/bt30/create_html.php?qid='.$quiz->id.'"><strong>BT30 Manager</strong></a>';
    }else{
		echo '<a href="/mod/bt72/create_html.php?qid='.$quiz->id.'"><strong>BT72 Manager</strong></a><br>';
	}
	//End BT30 - Chuc nang tao quiz - Tinhth
    print_box_end();
