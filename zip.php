...
<tr>
    <td style="background-color:#2B6082; color:#FFFFFF; padding:5px;" align="left"><b>Current directory : <a href="?dirname=.">Ziper</a> <?php
...
?>
  <tr>
    <td align="left" class="<?php echo $class?>"><input type="checkbox" name="zdir[]" value="<?php echo $entry?>" />&nbsp;<?php echo $name?></td>
  </tr>
<?php } ?>
<tr>
...
if ($step==1) {
	...
	if (count($zdir)>0) {
		...
		?>
		<script language="javascript">getobj('status').innerHTML="<p><b>Zip successful !</b></p><p>Download : <a href='<?php echo $conf['dir']?>/<?php echo $zipname?>'><?php echo $zipname?></a></p><p>Original size : <?php echo $zdirsize?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Zip size : <?php echo zipsize?></p>";</script>
		<?php
	} else {
