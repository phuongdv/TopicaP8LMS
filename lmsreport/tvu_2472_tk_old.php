...
(Với những câu sinh viên đặt từ 17:00 ngày chủ nhật đến 17:00 ngày thứ 6)</th>
  ...
  <tr>
    ...
    <td align="center">&nbsp; <?php echo $dem_is_qua_han.' / '.$dem_is_to_po_qh ;?></td>
    <td align="center">&nbsp; <?php  echo $dem_po_qua_han.' / '.$dem_po_to_gv_qh ;?></td>
	<td align="center">&nbsp; <?php echo $dem_is_trong_han.' / '.$dem_is_to_po ;?></td>
    <td align="center">&nbsp; <?php  echo $dem_po_trong_han.' / '.$dem_po_to_gv ;?></td>
    <td align="center">&nbsp; <?php  echo $dem_nghi ;?></td>
  </tr>
