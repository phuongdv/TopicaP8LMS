<?
require_once("class/class_profiling.inc.php");

$profil=new profiling();

	extract($_REQUEST);//This file is necesary if you have register_globas OFF in your php.ini
	$select="SELECT username,shortname,name,so_cau_h2472_duoc_assign,so_cau_h2472_datraloi_dunghan,so_cau_h2472_datraloi_quahan,so_cau_h2472_ko_tra_loi";
	$from="FROM view_h2472_report";
	$where="";
	$group="";
	...
	*/
	$field_names=array("Username","Course name","Role name","Số được assign","Số trả lời đúng hạn","Số trả lời quá hạn","Số không trả lời");
	$page_title="H2472 report";
