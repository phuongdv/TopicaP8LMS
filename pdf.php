...
<object data="<? echo $arrBai['pdf']; ?>" type="application/pdf" width="100%" height="800">
 
  <p>Trình duyệt của bạn không hỗ trợ đọc file PDF.<a href="<? echo $arrBai['pdf']; ?>"> Nhấn vào đây để tải file về.</a></p>
