...
$mysqli->select_db($dbmain);
		...
		//echo $sql4.'<br>';
		echo '<table border="1" cellpacing="0" >
		<tr><th>id</th><th>lastname</th><th>firstname</th>';
		$ad4 = $mysqli->query($sql4);
			while($dd4 = $ad4->fetch_assoc()) 
			{
				echo '<th>'.$dd4['week_name'].'</th>';
...
$mysqli->query("SET NAMES 'utf8'");
	...
	{
		echo '<tr><td>'.$dd['id'] . '</td><td>' .$dd['lastname'] . '</td><td>' . $dd['firstname']. '</td>';
		u_co($dd['id'],$c_id);
		//u_in_c($dd['id'],4);
		echo '</tr>';
	}
