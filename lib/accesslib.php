<?php // $Id: accesslib.php,v 1.421.2.98 2009/02/12 02:29:34 jerome Exp $
 ...
 * @return array()
 */
function get_role_users($roleid, $context, $parent=false, $fields='',$condition='',$sort='u.lastname ASC', $gethidden=true, $group='', $limitfrom='', $limitnum='') {
    global $CFG;
    if (empty($fields)) {
    ...
    $SQL = "SELECT $fields, ra.roleid
            ...
            JOIN {$CFG->prefix}role r
              ON ra.roleid = r.id
            $groupjoin
            WHERE (ra.contextid = $context->id $parentcontexts $condition)
