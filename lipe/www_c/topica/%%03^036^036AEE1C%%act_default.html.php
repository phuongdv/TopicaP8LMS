<?php /* Smarty version 2.6.18, created on 2014-02-19 14:44:59
...
?>
                ...
                <!-- danglx them bien checkDoQuiz2  kiem tra lam bai BT72, BT30 -->
                <?php $this->assign('checkDoQuiz2', $this->_tpl_vars['clsSettingCalendar']->checkDoQuiz2($this->_tpl_vars['arrUser'][$this->_sections['id']['index']]['id'],$this->_tpl_vars['quiz'])); ?>
                ...
                <?php if ($this->_tpl_vars['checkDoQuiz2'] == '0'): ?>
                <tr height="25" >
