...
";
	...
	mb_internal_encoding('UTF-8');
	mysql_query("set names 'utf8'",$con);*/
	$arrCourseFI = $clsCourse->GetAll("(fullname LIKE '%A%' or fullname LIKE '%B%') and id!= 15 and id!= 9 and id!= 18 order by fullname asc"); 
	$arrCourseBA = $clsCourse->GetAll("fullname LIKE '%C%' and fullname LIKE '%D%' and id!= 22 and id!= 39 and id!= 42 and id!= 7 order by fullname asc");
	$arrCourseIT = $clsCourse->GetAll("fullname LIKE '%G%' order by fullname asc");
