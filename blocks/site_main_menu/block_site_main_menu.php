<?php   //$Id: block_site_main_menu.php,v 1.26.2.4 2008/03/03 11:41:04 moodler Exp $
	...
	class block_site_main_menu extends block_list {
		function init() {
			$this->title = get_string('main.block_main_menu', 'block_login_logout');
					...
					foreach($modinfo->sections[0] as $cmid) {
						...
						if ($cm->modname == 'label') {
							...
							if($cm->id != 5140){
								...
								$this->content->items[] = '<a TARGET="_blank" title="'.$cm->modplural.'" '.$linkcss.' '.$cm->extra.
								' href="http://forum.amatop.ph/forum.php">'.$instancename.'</a>';
							}
