...
class block_report extends block_base {
  function init() {
    $this->title   = get_string('ra.block_main_menu', 'block_login_logout');
...
function get_content() {
	...
	if($role==1 || $role==13 || $role==11 || $role==211 || $role==3)
    {	
	$this->content->text ='<a href="/lmsreport/LMS240-H2472">'.get_string('ra.baocaoh2472', 'block_login_logout').'</a><br>
	<a href="/lmsreport/index.php">'.get_string('ra.baocaocongviecgiaovientheocourse', 'block_login_logout').'</a><br>
	<a href="/lmsreport/coursereport/">'.get_string('ra.baocaotinhhinhtheocourse', 'block_login_logout').'</a><br>
	<a href="/lmsreport/LMS250-quiz">'.get_string('ra.baocaothuchiennhiemvuhoctap', 'block_login_logout').'</a><br>
	...
	{
	 $this->content->text ='<a href="/lmsreport/LMS240-H2472">'.get_string('ra.baocaoh2472', 'block_login_logout').'</a><br>
	 <a href="/lmsreport/index.php">'.get_string('ra.baocaocongviecgiaovientheocourse', 'block_login_logout').'</a>';
