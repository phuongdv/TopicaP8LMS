...
class block_admin extends block_list {
    ...
    /// View reportlipe
        if ($course->id !== SITEID and has_capability('moodle/site:viewreports', $context)) { // basic capability for listing of reports
            ...
            $this->content->items[]='<a target="_blank" href="/lipe-tvu">'.get_string('reportlipe').'</a>';
            $this->content->icons[]='<img src="'.$CFG->pixpath.'/i/stats.gif" class="icon" alt="" />';
        }
 /*       
  /// View reportlipe 2014
        if ($course->id !== SITEID and has_capability('moodle/site:viewreports', $context)) { // basic capability for listing of reports
            $xx="demo";
            $b64=base64_encode($xx);
            $this->content->items[]='<a target="_blank" href="/lipe2014">'.get_string('reportlipe').' lipe 2014</a>';
            $this->content->icons[]='<img src="'.$CFG->pixpath.'/i/stats.gif" class="icon" alt="" />';
        }
  */      
        ...
        if ($course->id !== SITEID and has_capability('moodle/site:viewreports', $context)) { // basic capability for listing of reports
            $xx="demo";
            $b64=base64_encode($xx);
            $this->content->items[]='<a target="_blank" href="/lipe2014/interaction_base_web.php">'.get_string('reportlipe').' lipe 2014 v2</a>';
            $this->content->icons[]='<img src="'.$CFG->pixpath.'/i/stats.gif" class="icon" alt="" />';
        }
	/// View reportlipe
        if ($course->id !== SITEID and has_capability('moodle/site:viewreports', $context)) { // basic capability for listing of reports
			...
			if( $course->id==2118 or $course->id==2117 or $course->id == 2119)
			{
			$this->content->items[]='<a target="_blank" href="/tma">Quản lý TMA </a>';
			}
            $this->content->icons[]='<img src="'.$CFG->pixpath.'/i/stats.gif" class="icon" alt="" />';
        }
