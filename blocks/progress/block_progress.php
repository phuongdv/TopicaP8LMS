...
class block_progress extends block_base {
    ...
    function get_content() {
        ...
        // Display progress bar
            ...
            // Start table
            $this->content->text .= '<div style="bottom: 0px; width: 203px; position: fixed;"><div class="header"><div class="title"><h2 style="text-align: center;">Nhiệm vụ học tập theo tuần</h2></div></div><div class="content" style="border: 1px #790000 solid; min-height: 130px">            
            <table class="progressBarProgressTable" width="100%" cellpadding="0" cellspacing="0">';
            ...
            foreach($eventArray as $event) {
                $this->content->text .= '<td class="progressBarCell" style="border-right: 1px #fff solid;" width="'.$width.'%" onclick="document.location=\''.$CFG->wwwroot.'/mod/'.$event['type'].'/view.php?'.'id='.$event['moduleID'].'\';"';
            ...
            <div class="progressEventInfo" id="progressBarInfo'.$this->instance->id.'">'.get_string('mouse_over_prompt','block_progress').'<br /><span style="background-color:#33CC00" id="attemptedColour" class="colourBox">&nbsp;&nbsp;&nbsp;</span> Đã thực hiện, còn hạn<br /><span style="background-color:#FF3300" id="notAttemptedColour" class="colourBox">&nbsp;&nbsp;&nbsp;</span> Chưa thực hiện. hết hạn<br /><span style="background-color:#3366FF" id="futureNotAttemptedColour" class="colourBox">&nbsp;&nbsp;&nbsp;</span> Chưa thực hiện, còn hạn</div></div></div>
            ';
        }
