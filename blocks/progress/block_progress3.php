...
class block_progress extends block_base {
    ...
    function get_content() {
        ...
        // Display progress bar
            ...
            // Start table
            $this->content->text .= '<div style="bottom: 0px; width: 203px; position: fixed;"><div class="header"><div class="title"><h2 style="text-align: center;">Nhiệm vụ học tập</h2></div></div><div class="content" style="border: 1px #790000 solid; min-height: 130px">            
            ...
            <div class="progressEventInfo" id="progressBarInfo'.$this->instance->id.'">'.get_string('mouse_over_prompt','block_progress').'</div></div></div>
            ';
        }
