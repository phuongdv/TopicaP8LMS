...
class block_progress extends block_base {
    ...
    function get_content() {
        ...
        // Display progress bar
            ...
            // Start table
            $this->content->text .= '<div style="bottom: 0px; width: 203px; position: fixed;"><div class="header"><div class="title"><h2>Nhie^.m vu. ho.c ta^.p theo tua^`n</h2></div></div><div class="content" style="border: 1px #790000 solid;">            
