...
if(isMobileDevice()){
	echo '<script> window.location.assign("http://eldata11.topica.vn/HocLieu/Confirm/Confirm.html?video='.$arrBai['slide'].'&audio='.$arrBai['new_slide'].'")</script>';
}
...
<script> 
	function onload(){
		...
		frames[0].location = '<? echo $arrBai['slide']; ?>';
	}
</script>
...
<div style="width:100%" style="background-color:#606060;" align="center">
	<iframe scrolling="no" style="min-height:650px;width:75%;" frameborder="0" border="0" framespacing="0" src="<? echo $arrBai['slide']; ?>"></iframe>
</div>
</body>
</html>