...
echo "<table width='70%' border='1' cellpadding='3' cellspacing='0' align='center' bordercolor='#810C15'>";
	...
	echo "<th bgcolor='#810C15'><span class='style1'>Chức vụ trong lớp</span></th>";
	echo "<th bgcolor='#810C15'><span class='style1'>Nhóm</span></th>";
	echo "<th bgcolor='#810C15'><span class='style1'>Chức vụ trong nhóm</span></th>";
	echo "<th bgcolor='#810C15'><span class='style1'>Ghi chú</strong></th>";
	echo "<th bgcolor='#810C15'><span class='style1'>Kiểm tra username</strong></th>";
	...
	while ($row = mysql_fetch_array($result))
		{
			...
			echo "<td>".$row['chucvutronglop']."</td>";
			echo "<td>".$row['nhom']."</td>";
			echo "<td>".$row['chucvutrongnhom']."</td>";
