...
$gio = date("h");
$phut = date("i");
CenterString($im,40,8,'Bây giờ là:',11,$text_color,$font);
$str1 = $gio.'giờ'.$phut;
CenterString($im,40,31,$str1,13,$text_color,$font);
$str2 = "ngày $ngay tháng $thang";
CenterString($im,40,50,$str2,9,$text_color,$font);
$str3 = 'năm '.$nam;
CenterString($im,40,72,$str3,12,$text_color,$font);
imagejpeg($im);
imagedestroy($im);
