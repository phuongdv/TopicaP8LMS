...
if( time() <= ($me+$one_day) )
{
	...
	CenterString($im,$x3,$y4+5,$str1,10,$background_color,$font);
...
//	CenterString($im,$x5,$y5,$str3,8,$background_color,$font);
	...
	CenterString($im,$x3,$y4+5,$str1,10,$text_color,$font);
...
while ($me < $lDate)
	...
	{
		box2($im,$x1+$i*50,$y1,$x2+$i*50,$y2,$text_color,$background_color);
		CenterString($im,$x3+$i*50,$y4+5,$str1,10,$background_color,$font);
	//	CenterString($im,$x4+$i*64,$y5,$str2,8,$background_color,$font);
	//	CenterString($im,$x5+$i*64,$y5,$str3,8,$background_color,$font);
	}
	else 
	{	
		box($im,$x1+$i*50,$y1,$x2+$i*50,$y2,$text_color);
		CenterString($im,$x3+$i*50,$y4+5,$str1,10,$text_color,$font);
