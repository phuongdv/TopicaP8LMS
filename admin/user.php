...
WHERE u.id=$userid and r.id!=1";
    ...
    $columns = array("firstname", "lastname", "email", "city", "country", "lastaccess", "coursecount");
    ...
    if (!$users) {
        ...
        $table->head = array ($fullnamedisplay, $email, "$coursecount", $city, $country, $lastaccess, "", "", "");
        $table->align = array ("left", "left", "center", "left", "left", "left", "center", "center", "center");
        $table->width = "95%";
        foreach ($users as $user) {
