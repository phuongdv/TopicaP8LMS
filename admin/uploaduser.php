...
$STD_FIELDS = array('id', 'firstname', 'lastname', 'username', 'email', 
        ...
        'url', 'description', 'oldusername', 'emailstop', 'deleted',  'password',
		'topica_nganh', 'topica_lop', 'topica_nhom', 'topica_coquan',
		'topica_namsinh', 'topica_dienthoai', 'topica_ym', 'topica_chucdanh','topica_msv');
