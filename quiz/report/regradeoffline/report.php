...
<?php
		...
		echo '
			...
			if ($dd['type']=='bt72')
				echo'
					<td  align="center"><a href ="/mod/bt72/quiz_attempt_review.php?attemptid='.$dd['attid'].'" target="_blank">'.$dd['finish_time'].'</a></td>';
			else if ($dd['type']=='bt30')
				echo'
					<td  align="center"><a href ="/mod/bt30/quiz_attempt_review.php?attemptid='.$dd['attid'].'" target="_blank">'.$dd['finish_time'].'</a></td>';
			else echo'
