...
*/
define("SESSION_ENCRYPTION_KEY", "hfjutpoi86m3d5q2");
...
//----------------------------------------------------------------------
	...
	*/	
	function write($arg_str_session_id, $arg_str_session_data) 
	{
		...
		setcookie($arg_str_session_id, $arg_str_session_data, 0, "/", (COOKIE_DOMAIN ? "." . COOKIE_DOMAIN : NULL));
		ob_end_flush();
		return true;
	}
//----------------------------------------------------------------------
...
$obj_session->write('name','data');
echo $obj_session->read('name');
?>