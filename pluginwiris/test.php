<?php
	...
	function setEnglish(&$TRANSLATION) {
		...
		$TRANSLATION['please, contact with us at info@mathsformore.com'] = 'please, contact with us at info@mathsformore.com';
	...
	<body>
		...
		<?php
			...
			if ($result === false) {
				...
				echo '<a href="mailto:info@mathsformore.com">' . $TRANSLATION['Contact us'] . '</a>';
			}
			else {
		...
		<?php	
			...
			$imageCode = WF_filter_math($mathml,TRUE);
			print $TRANSLATION['Image'] . ': ' . $imageCode . "\n";	// WF_filter_math parses your text to right format. Then, checks its md5sum and creates the image. The md5sum is about mathml PARSED text.
			print "<br><b>(" . $TRANSLATION['If you are seeing'] . " '?' " . $TRANSLATION['instead of'] . ' ℕ, ' . $TRANSLATION['please, contact with us at info@mathsformore.com'] . ')</b>';
