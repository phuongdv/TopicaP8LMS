<?PHP // $Id: notes.php,v 1.1 2012/02/16 18:48:33 koenr Exp $ 
      // notes.php - created with Moodle 1.9.7 (Build: 20091126) (2007101570)
...
$string['cannotdeletepost'] = 'Có lỗi xảy ra khi xoá bài viết';
$string['configenablenotes'] = 'Mở chức năng lưu trữ ghi chú về cá nhân thành viên';
$string['content'] = 'Nội dung';
$string['course'] = 'khoá học';
$string['coursenotes'] = 'Ghi chú trong khoá học';
$string['created'] = 'ngày tạo';
$string['deleteconfirm'] = 'Xoá ghi chú này?';
$string['deletenotes'] = 'Xoá mọi ghi chú';
$string['editnote'] = 'Sửa ghi chú';
$string['enablenotes'] = 'Mở chức năng ghi chú';
$string['groupaddnewnote'] = 'Thêm ghi chú chung';
$string['invalidid'] = 'Số hiệu ghi chú không hợp lệ';
$string['nocontent'] = 'Không thể để trống nội dung ghi chú';
$string['nonotes'] = 'Hiện chưa có ghi chú loại này';
$string['nopermissiontodelete'] = 'bạn không thể xoá ghi chú này';
$string['note'] = 'Ghi chú';
$string['notes'] = 'Ghi chú';
$string['notesdisabled'] = 'Rất tiếc, chức năng ghi chú đã bị tắt';
...
$string['sitenotes'] = 'Ghi chú toàn hệ thống';
