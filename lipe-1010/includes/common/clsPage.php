	  ...
	  */	   
	  function get_first_page_nav($user_link="",$link_para="")
      {
        ...
        if(!$this->is_first_page()&& $this->show_first_last)
        {
        	...
        	return ' <a href="'.$this->page_name.'&page=0'.$this->qry_str.'" '.$link_para.' class="menu3">'.$user_link.'</a> ';
		}
      ...
      function get_last_page_nav($user_link="",$link_para="")
      {
        ...
        {    
        	...
        	return ' <a href="'.$this->page_name.'&page='.($this->total_page-1).$this->qry_str.'" '.$link_para.' class="menu3">'.$user_link.'</a> ';
		}
		elseif($this->show_first_last && $this->show_disabled_links)
        {    
			//echo $user_link;
      ...
      function get_next_page_nav($user_link="",$link_para="")
      {
        ...
        if(!$this->is_last_page()&& $this->show_prev_next)
		{
        	...
        	return ' <a href="'.$this->page_name.'&page='.($this->page+1).$this->qry_str.'" '.$link_para.' class="menu3">'.$user_link.'</a> ';
		}
      ...
      function get_scroll_prev_page_nav($user_link="",$link_para="")
      {
        ...
        {    
			...
			return ' <a href="'.$this->page_name.'&page='.($this->page-$this->scroll_page).$this->qry_str.'" '.$link_para.' class="menu3">'.$user_link.'</a> ';
		}	
      ...
      function get_number_page_nav($link_para="")
      {
        ...
        for(;$i<$j+$scroll_page && $i<$this->total_records;$i++)
        {
			 ...
			 {   
				...
				$str.=' <a href="'.$this->page_name.'&page='.$i.$this->qry_str.'" '.$link_para.' class="menu3">'.($i+1).'</a> ';
			 }     
		}
		return $str;
      }
