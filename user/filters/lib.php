...
class user_filtering {
    ...
    function user_filtering($fieldnames=null, $baseurl=null, $extraparams=null) {
        ...
        if (empty($fieldnames)) {
            $fieldnames = array('username'=>0, 'realname'=>0, 'lastname'=>1, 'firstname'=>1, 'email'=>1, 'city'=>1, 'country'=>1,
                                'confirmed'=>1, 'profile'=>1, 'courserole'=>1, 'systemrole'=>1,
                                'firstaccess'=>1, 'lastaccess'=>1, 'lastlogin'=>1, 'auth'=>1, 'mnethostid'=>1);
        }
    ...
    function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'coursecount':       return new user_filter_text('coursecount', get_string('coursecount'), $advanced, 'coursecount');
