...
//không require    $mform->addRule('topica_lop', $strrequired, 'required', null, 'client');

	$choices = array();
    $choices['chua_xac_dinh'] = get_string('topica_nganh_0');
    $choices['quan_tri_kinh_doanh'] = get_string('topica_nganh_ba');
    $choices['ke_toan'] = get_string('topica_nganh_fi1');
    $choices['tai_chinh_ngan_hang'] = get_string('topica_nganh_fi2');
    $choices['tin_hoc'] = get_string('topica_nganh_it');
    $mform->addElement('select', 'topica_nganh', get_string('topica_nganh'), $choices);

	$choices = array();
    $choices['chua_phan_nhom'] = get_string('topica_nhom0');
    $choices['1'] = get_string('topica_nhom1');
    $choices['2'] = get_string('topica_nhom2');
    $choices['3'] = get_string('topica_nhom3');
    $choices['4'] = get_string('topica_nhom4');
    $choices['5'] = get_string('topica_nhom5');
	...
	$choices = array();
    $choices['nhân vin'] = get_string('topica_chucdanh_nhanvien');
    $choices['chuyen vien'] = get_string('topica_chucdanh_chuyenvien');
    $choices['2'] = get_string('topica_chucdanh_truongnhom');
    $choices['3'] = get_string('topica_chucdanh_phophong');
    $choices['4'] = get_string('topica_chucdanh_truongphong');
    $choices['5'] = get_string('topica_chucdanh_phogiamdoc');
    $choices['6'] = get_string('topica_chucdanh_giamdoc');
    $choices['7'] = get_string('topica_chucdanh_chucdanhkhac');
    $choices['8'] = get_string('topica_chucdanh_chuadilam');
    $mform->addElement('select', 'topica_chucdanh', get_string('topica_chucdanh'), $choices);
    	
	$choices = array();
    $choices['0'] = get_string('topica_trinhdo_thpt');
    $choices['1'] = get_string('topica_trinhdo_tc');
    $choices['2'] = get_string('topica_trinhdo_cd');
    $choices['3'] = get_string('topica_trinhdo_dh');
    $mform->addElement('select', 'topica_trinhdo', get_string('topica_trinhdo'), $choices);

	$choices = array();
    $choices['0'] = get_string('topica_doituongtuyensinh_0');
    $choices['1'] = get_string('topica_doituongtuyensinh_1');
    $choices['2'] = get_string('topica_doituongtuyensinh_2');
    $choices['3'] = get_string('topica_doituongtuyensinh_3');
    $choices['4'] = get_string('topica_doituongtuyensinh_4');
	...
	$choices = array();
    $choices['0'] = get_string('topica_status_binhthuong');
    $choices['1'] = get_string('topica_status_hanghai');
    $choices['2'] = get_string('topica_status_baodong');
