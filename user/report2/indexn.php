	...
	while($row = mysql_fetch_array($result))
					{   $nganh=$row[topica_nganh];
						...
						echo" <tr id=\"tabletd\" class=\"tablecontent\"style=\"font-size:9pt\">
						        ...
						        <td>&nbsp;$row[lastname]</td>
						        <td>&nbsp;$row[firstname]</td>
						        <td><a href=\"http://210.245.9.197/SCMSWebPortal/StudentProfiles.aspx?tab=lylich&idhv=$user_b64&idcvht=$userlogin_bs64\" target=\"_blank\" >$row[username]</a></td>
						...
						else 
						{
							...
							echo" <tr bgcolor=\"black\" id=\"tabletd2\" class=\"tablecontent\" style=\"font-size:9pt\" >
						        <td > $tr</td>
						        <td>&nbsp;$row[lastname]</td>
						        <td>&nbsp;$row[firstname]</td>
						        <td><a href=\"http://210.245.9.197/SCMSWebPortal/StudentProfiles.aspx?tab=lylich&idhv=$user_b64&idcvht=$userlogin_bs64\" target=\"_blank\" >$row[username]</a></td>
...
<fieldset>
<form id="form1" name="form1" method="post" action="danhsachlopn.php" >
  <table width="100%"  cellpadding="0" cellspacing="0" style="border:solid 1px #840C10; font-family:Tahoma, Geneva, sans-serif; font-size:12px;" bgcolor="#F0F0F0" >
    ...
    <tr>
      ...
      <td colspan="6"><div align="center">
        <label>
        <input type="submit" name="submit" id="submit" value="     Xem   " />
        </label>
      </div></td>
      <td></td>
    </tr>
...
echo 'Loc theo:'.$nganh.'&'.$lop.'&'.$nhom.'&'.$chucdanh.'&'.$chucvu.'&'.$chucvutrongnhom.'&'.$candidate.'&'.$trangthai.'&'.$username;
  }
?>
</table>
...
if ($prev_page >= 1)
{
    echo ("<b>&lt;&lt;</b> <a href=\"danhsachlopn.php?page=$prev_page&limit=$limit\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \"><b>Trang tr&#432;&#7899;c</b></a>");
}
...
for ($a = 1; $a <= $numPages; $a++)
{
    ...
    {
        echo ("  <a href=\"http://www.topica.vn/elearning/user/danhsachlopn.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&username=$username&limit=$limit&page=$a\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \">$a </a> | ");
    }
}
...
if ($next_page <= $numPages)
    ...
    echo ("<a href=\"danhsachlopn.php?page=$next_page&limit=$limit\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \"><b>Trang sau</b></a> &gt; &gt;");
