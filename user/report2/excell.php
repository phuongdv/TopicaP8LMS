 ...
 <Worksheet ss:Name="Sheet1">
  ...
  <Table ss:ExpandedColumnCount="18" ss:ExpandedRowCount="<? $total=$total+4;echo"$total"; ?>" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="42.75">
    ...
    <Cell ss:StyleID="s69"><Data ss:Type="String">H�?</Data></Cell>
    ...
    <Cell ss:StyleID="s69"><Data ss:Type="String">�?ối tượng tuyển sinh</Data></Cell>

    <Cell ss:StyleID="s70"><Data ss:Type="String">Trạng thái</Data></Cell>

    <Cell ss:StyleID="s71"><Data ss:Type="String">Ghi chú</Data></Cell>
