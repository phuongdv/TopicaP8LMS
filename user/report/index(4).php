  ...
  <table width="100%"  cellpadding="0" cellspacing="0" style="border:solid 1px #840C10; font-family:Tahoma, Geneva, sans-serif; font-size:12px;" bgcolor="#F0F0F0" >
    ...
    <tr>
      ...
      <td align="right" style="padding-right:10px"><label>
        <input type="text" name="username" id="username" value="<?echo $username;?>"  style="width:146px"/>
      </label></td>
    </tr>
    <tr>
      <td align="right"></td>
...
if ($prev_page >= 1)
{
    echo ("<b>&lt;&lt;</b> <a href=\"danhsachlop.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&username=$username&limit=$limit&page=$prev_page\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \"><b>Trang tr&#432;&#7899;c</b></a>");
}
...
for ($a = 1; $a <= $numPages; $a++)
{
    ...
    {
        echo ("  <a href=\"danhsachlop.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&username=$username&limit=$limit&page=$a\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \">$a </a> | ");
    }
}
...
if ($next_page <= $numPages)
    ...
    echo ("<a href=\"danhsachlop.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&username=$username&limit=$limit&page=$next_page\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \"><b>Trang sau</b></a> &gt; &gt;");

echo '</p>';
echo ("  <a href=\"report/excell.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&username=$username\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \">EXCELL </a> | ")
;
