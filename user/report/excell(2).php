...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Sheet1">
  <Table ss:ExpandedColumnCount="50" ss:ExpandedRowCount="50000" x:FullColumns="1"
   x:FullRows="1" ss:DefaultRowHeight="15">
   <Column ss:AutoFitWidth="0" ss:Width="18"/>
   <Column ss:AutoFitWidth="0" ss:Width="84"/>
   <Column ss:AutoFitWidth="0" ss:Width="69.75"/>
   <Column ss:Index="5" ss:AutoFitWidth="0" ss:Width="88.5"/>
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell><Data ss:Type="String">vietth</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0">
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s63"><Data ss:Type="String">H&#7885;</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">T&#234;n</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">L&#7899;p</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Ng&#224;nh</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Nh&#243;m</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">C&#417; quan</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Ch&#7913;c danh</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Ch&#7913;c v&#7909; trong l&#7899;p</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Ch&#7913;c v&#7909; trong nh&#243;m</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Candidate</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Tr&#236;nh &#273;&#7897;</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">&#272;&#7889;i t&#432;&#7907;ng tuy&#7875;n sinh</Data></Cell>
    <Cell ss:StyleID="s64"><Data ss:Type="String">Tr&#7841;ng th&#225;i</Data></Cell>
    <Cell ss:StyleID="s65"><Data ss:Type="String">Ghi ch&#250;</Data></Cell>
   </Row>
<?php 
...
//echo"$sql";
	...
	<Cell ss:Index=\"1\" ss:StyleID=\"s63\"><Data ss:Type=\"Number\">$stt</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[lastname]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[firstname]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_lop]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_nganh]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_nhom]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_coquan]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_chucdanh]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_chucvutronglop]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_chucvutrongnhom]</Data></Cell>\n
	<Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_candidate]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_trinhdo]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_doituongtuyensinh]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_status]</Data></Cell>\n
    <Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">$row[topica_ghichu]</Data></Cell>\n
	</Row>\n
    ";
	}
     /*
