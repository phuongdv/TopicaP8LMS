...
include('lang/report.php');
			   ...
			   {
			   	$keyword="";//dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨ault
			   }
			   else 
...
$numPages=0;
			...
			if(!isset($_GET['limit'])|| $_GET['limit']=='')
			{
			   ...
			   {
			   	$limit=30;//dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨ault
			   }
			   else 
	...
	while($row = mysql_fetch_array($result))
					{   $nganh=$row[topica_nganh];
						...
						else 
						{
							...
							echo" <tr id=\"tabletd2\" class=\"tablecontent\" style=\"font-size:9pt\" >
						        <td > $tr</td>
						        <td>&nbsp;$row[lastname]</td>
						        <td>&nbsp;$row[firstname]</td>
                                <td>&nbsp;$row[username]</td>
...
<form id="form1" name="form1" method="post" action="danhsachlop.php" >
  <table width="100%"  cellpadding="0" cellspacing="0" style="border:solid 1px #840C10; font-family:Tahoma, Geneva, sans-serif; font-size:12px;" bgcolor="#F0F0F0" >
    <tr height="30">
    	<td width="10%"  align="left" style="padding-left:10px"><?echo $string['nganh']?></td>
      <td width="16%"  align="right" >
        <label>
      <select name="nganh" id="nganh"  style="width:150px">
      ...
      <td width="4%"></td>
      <td width="16%" align="left" style="padding-left:10px"><?echo $string['chucdanh']?> </td>
      <td width="16%" align="right" >
        <label>
        <select name="chucdanh" id="chucdanh" style="width:150px">
          <option value=""><?echo $string['tatca'];?></option>
      ...
      <td width="12%"></td>
      <td width="10%" align="left" style="padding-left:10px">Candidate</td>
      <td width="16%" align="right" style="padding-right:10px"> 
        <label>
        <select name=" candidate" id=" candidate" style="width:150px">
          <option value=""><?echo $string['tatca'];?></option>
    ...
    <tr height="30">
    	<td align="left" style="padding-left:10px"><? echo $string['lop']?></td>
      <td align="right"><label>
        <!--<input type="text" name="lop" id="lop" value="<?echo $lop;?>" style="width:146px"/>-->
         <select name="lop" id="lop" style="width:150px">
         <option value=""><?echo $string['tatca'];?></option>
         <? get_selectdata("topica_lop",$lop); ?>
         </select>
      </label></td>
      <td ></td>
      <td align="left" style="padding-left:10px"><? echo $string['chucvutronglop']?></td>
      <td align="right">
        <label>
        <select name="chucvu" id="chucvu" style="width:150px">
          <option value=""><?echo $string['tatca'];?></option>
      ...
      <td></td>
      <td align="left" style="padding-left:10px"><? echo $string['trangthai']?></td>
      <td align="right" style="padding-right:10px">
        <label>
        <select name="trangthai" id="trangthai" style="width:150px">
          <option value=""><?echo $string['tatca'];?></option>
    ...
    <tr>
    	<td align="left" style="padding-left:10px"><?echo $string['nhom']?></td>
      <td align="right" >
        <label>
        <select name="nhom" id="nhom" style="width:150px">
          <option value=""><?echo $string['tatca'];?></option>
		  <?php for ($i=1;$i<=19;$i++){ 
		  echo '<option value="N'.$i.'">'.$i.'</option>';
		  }
		  ?>
      ...
      <td ></td>
      <td align="left" style="padding-left:10px"><? echo $string['chucvutrongnhom']?></td>
      <td align="right" >
        <label>
        <select name="chucvutrongnhom" id="chucvutrongnhom" style="width:150px">
          <option value=""><? echo $string['tatca'] ?></option>
      ...
      <td></td>
      <td align="left" style="padding-left:10px"><? echo $string['timkiem']?></td>
      <td align="right" style="padding-right:10px"><label>
        <input type="text" name="keyword" id="keyword" value="<?echo $keyword;?>"  style="width:146px"/>
      </label></td>
    </tr>
    <tr>
      <td align="right"></td>
    ...
    <tr>
      <td style="padding-left:10px;" colspan="2"><? echo $string['hien'] ?><select name="limit" id="limit">
      <?
...
{   
	...
	{
	$username_qry="AND CONCAT_WS(' ',username,trim(lastname),trim(firstname),topica_lop,topica_chucdanh,topica_coquan,topica_chucvutronglop,topica_chucvutrongnhom,topica_status) LIKE '%$keyword%'";	
...
if ($prev_page >= 1)
{
    echo ("<b>&lt;&lt;</b> <a href=\"danhsachlop.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&keyword=$keyword&limit=$limit&page=$prev_page\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \"><b>Trang tr&#432;&#7899;c</b></a>");
}
...
for ($a = 1; $a <= $numPages; $a++)
{
    ...
    {
        echo ("  <a href=\"danhsachlop.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&keyword=$keyword&limit=$limit&page=$a\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \">$a </a> | ");
    }
}
...
if ($next_page <= $numPages)
    ...
    echo ("<a href=\"danhsachlop.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&keyword=$keyword&limit=$limit&page=$next_page\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \"><b>Trang sau</b></a> &gt; &gt;");

echo '</p>';
echo ("  <a href=\"report/excell.php?nganh=$nganh&chucdanh=$chucdanh&candidate=$candidate&lop=$lop&chucvu=$chucvu&trangthai=$trangthai&nhom=$nhom&chucvutrongnhom=$chucvutrongnhom&keyword=$keyword&total=$total\" style=\" font-family:tahoma; color:#810C15; font-size:12px;  \">EXCELL </a> | ")
;
