...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
  ...
  <Author>Le Xuan Dang</Author>

  <LastAuthor>LẼUANDANG</LastAuthor>

  <Created>2013-12-06T09:09:14Z</Created>
 ...
 <Worksheet ss:Name="Sheet1">
  ...
  <Table ss:ExpandedColumnCount="18" ss:ExpandedRowCount="<? $total=$total+4;echo "$total"; ?>" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s72"><Data ss:Type="String">danglx</Data></Cell>
   ...
   <Row ss:AutoFitHeight="0">
	...
	<Cell ss:StyleID="s72"><Data ss:Type="String"><?php echo date("d-m-Y"); ?></Data></Cell>
   </Row>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="22.75">
    ...
    <Cell ss:StyleID="s69"><Data ss:Type="String">Họ và đệm</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Tên </Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Lớp</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Ngành</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Nhóm</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Cơ quan</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Chức danh</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Chức vụ trong lớp</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Chức vụ trong nhóm</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Candidate</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Trình độ</Data></Cell>

    <Cell ss:StyleID="s69"><Data ss:Type="String">Đối tượng tuyển sinh</Data></Cell>

    <Cell ss:StyleID="s70"><Data ss:Type="String">Trạng thái</Data></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">Ghi chu</Data></Cell>
	<Cell ss:StyleID="s71"><Data ss:Type="String">CourseCount</Data></Cell>
